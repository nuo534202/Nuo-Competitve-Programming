#include<bits/stdc++.h>
using namespace std;
vector<vector<int>> en = {{1, 2, 4}, {1, 4, 5}, {1, 5, 3}, {1, 3, 2}, {2, 4, 1}, {2, 1, 3}, {2, 3, 6}, {2, 6, 4}, {3, 2, 1}, {3, 1, 5}, {3, 5, 6}, {3, 6, 2},
                          {4, 2, 6}, {4, 6, 5}, {4, 5, 1}, {4, 1, 2}, {5, 4, 6}, {5, 6, 3}, {5, 3, 1}, {5, 1, 4}, {6, 2, 3}, {6, 3, 5}, {6, 5, 4}, {6, 4, 2}};
